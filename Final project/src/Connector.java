...
public class Connector {
	...
	try {
		...
		connecting = DriverManager.getConnection("jdbc:mysql://localhost:3306/pt_pudding", "root", "");
		System.out.println("Sukses Connecting :D");
		
		yourstate=connecting.createStatement();
		checking = false;
	...
	try {
		Class.forName("com.mysql.jdbc.Driver");
		connecting = DriverManager.getConnection("jdbc:mysql://localhost:3306/", "root", "");
