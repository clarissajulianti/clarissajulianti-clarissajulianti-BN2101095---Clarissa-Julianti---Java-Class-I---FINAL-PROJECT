//Clarissa Julianti - JAVA I
	...
	public void view() {
		...
		try {
			resultingaja = connecting.select();
			...
			public void actionPerformed(ActionEvent arg0) {
				if(theBlankCheck(txtKode.getText(), txtNama.getText(),txtStok.getText() , txtHarga.getText())==false) {
					...
					if (cekKode(txtKode.getText())==false) {
						connecting.insert(txtKode.getText(), txtNama.getText(), Integer.parseInt(txtHarga.getText()), Integer.parseInt(txtStok.getText()));
			...
			public void actionPerformed(ActionEvent arg0) {
				if(theBlankCheck(txtKode.getText(), txtNama.getText(), txtHarga.getText(), txtStok.getText())==false) {
					if (table.getSelectedRow()>=0) {
						connecting.update(txtKode.getText(), Integer.parseInt(txtHarga.getText()), Integer.parseInt(txtStok.getText()));
		...
		MenuDelete.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (table.getSelectedRow()>=0) {
					...
					connecting.delete(tableModel.getValueAt(table.getSelectedRow(), 0).toString());
